...
def Full_Update(a_u,b_u,c_u,d_u,a,b,c,d,chi,d_phys,D,delta,h,Env,Env1,Env2,Env3,Gauge,Corner_method,N_iterF,Acc_E,Steps,Model):
...
####################################################################################################
#   c_u, a_u, b_u , c, a, b=basicA.Var_cb(c_u,a_u,b_u,a,b,c,d,Env,D,U1,d_phys,chi,Gauge,Corner_method)

#   a_u, c_u, d_u, a, c, d=basicA.Var_cb(a_u,c_u,d_u,c,d,a,b,Env1,D,U1,d_phys,chi,Gauge,Corner_method)
######

#   d_u, b_u, a_u, d, b, a=basicA.Var_cb(d_u,b_u,a_u,b,a,d,c,Env2,D,U1,d_phys,chi,Gauge,Corner_method)
#   
#   b_u, d_u, c_u, b, d, c=basicA.Var_cb(b_u,d_u,c_u,d,c,b,a,Env3,D,U1,d_phys,chi,Gauge,Corner_method)

######

#   a_u, b_u, d_u, a, b, d=basicA.Var_ad(a_u, b_u, d_u,a,b,c,d,Env,D,U1,d_phys,chi,Gauge,Corner_method)
#   
#   c_u, d_u, b_u, c, d, b=basicA.Var_ad(c_u, d_u, b_u,c,d,a,b,Env1,D,U1,d_phys,chi,Gauge,Corner_method)

######
#   b_u, a_u, c_u, b, a, c=basicA.Var_ad(b_u, a_u, c_u,b,a,d,c,Env2,D,U1,d_phys,chi,Gauge,Corner_method)


#   d_u, c_u, a_u, d, c, a=basicA.Var_ad(d_u, c_u, a_u,d,c,b,a,Env3,D,U1,d_phys,chi,Gauge,Corner_method)
...
#######################################################################################
#   print "\n"
#   c_u, a_u, b_u, c, a, b=basicC.Var_cab(c_u, a_u, b_u,a,b,c,d,Env,D,MPO_list,d_phys,chi,Gauge,Corner_method,plist)

#   print "\n"

#   b_u, d_u, c_u, b, d, c=basicC.Var_cab(b_u, d_u, c_u,d,c,b,a,Env3,D,MPO_list,d_phys,chi,Gauge,Corner_method,plist3)

#   print "\n"

#   d_u, b_u, a_u, d, b, a=basicC.Var_cab(d_u, b_u, a_u,b,a,d,c,Env1,D,MPO_list,d_phys,chi,Gauge,Corner_method,plist1)

#   print "\n"

#   a_u, c_u, d_u, a, c, d=basicC.Var_cab(a_u, c_u, d_u,c,d,a,b,Env2,D,MPO_list,d_phys,chi,Gauge,Corner_method,plist2)

###########################
#   print "\n"
#   a_u, c_u, d_u, a, c, d=basicC.Var_acd(a_u,c_u,d_u,a,b,c,d,Env,D,MPO_list,d_phys,chi,Gauge,Corner_method,plist00)

#   print "\n"

#   d_u, b_u, a_u, d, b, a=basicC.Var_acd(d_u,b_u,a_u,d,c,b,a,Env3,D,MPO_list,d_phys,chi,Gauge,Corner_method,plist33)
#   print "\n"

#   b_u, d_u, c_u, b, d, c=basicC.Var_acd(b_u,d_u,c_u,b,a,d,c,Env1,D,MPO_list,d_phys,chi,Gauge,Corner_method,plist11)
#   print "\n"

#   c_u, a_u, b_u, c, a, b=basicC.Var_acd(c_u,a_u,b_u,c,d,a,b,Env2,D,MPO_list,d_phys,chi,Gauge,Corner_method,plist22)
