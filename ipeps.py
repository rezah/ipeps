...
Gamma_a,Gamma_b,Landa_1,Landa_2,Landa_3,Landa_4=basic.produce_GammaLanda(q_D, q_phys)
...
Landa1=[Landa[0],Landa[3],Landa[2],Landa[1]]
...
#########################################################################################
 ...
 Gamma_a,Gamma_b,Landa_1,Landa_2,Landa_3,Landa_4=basic.Reload_itebd()
 #Gamma_a,Gamma_b,Landa_1,Landa_2,Landa_3,Landa_4=itebd.itebd_eff(Gamma_a,Gamma_b,Landa_1,Landa_2,Landa_3,Landa_4,chi,q_phys,D,N_iteritebd,h,Model,q_D)
...
# print Landa_4#,Landa_8[0],Landa_8[3],Landa_8[4],Landa_8[7]
 ...
 Landa=[Landa_1,Landa_4,Landa_3,Landa_2]
